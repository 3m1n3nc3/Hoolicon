...
class MY_Controller extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->fmt_sch_name = url_title($this->customlib->getAppName(), '_', true) . '_';  
        $this->fmt_sch_name_ = '_' . url_title($this->customlib->getAppName(), '_', true);  
...
class Parent_Controller extends MY_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->children = $this->session->userdata('parent_childs');
    }
