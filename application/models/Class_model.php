...
class Class_model extends CI_Model {
    ...
    public function getClassTeacher() {
        ...
        $query = $this->db->select('staff.*,class_teacher.id as ctid,classes.class,classes.id as class_id,sections.id as section_id,sections.section')->join("staff", "class_teacher.staff_id = staff.id")->join("classes", "class_teacher.class_id = classes.id")->join("sections", "class_teacher.section_id = sections.id")->group_by("staff.id, class_teacher.id, class_teacher.class_id, class_teacher.section_id")->get("class_teacher");
