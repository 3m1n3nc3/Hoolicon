    ...
    function index() {
        ...
        if ($this->form_validation->run() == TRUE) {
            ...
            if (isset($_FILES["logo"]) && !empty($_FILES["logo"]['name'])) {
                $newLogoName = $this->fmt_sch_name . $this->customlib->uniqueFileName('front_logo-', $_FILES["logo"]['name']);
            ...
            if (isset($_FILES["logo"]) && !empty($_FILES["fav_icon"]['name'])) {
                $newFavName = $this->fmt_sch_name . uniqid('front_fav_icon-', true) . '.' . strtolower(pathinfo($_FILES["fav_icon"]['name'], PATHINFO_EXTENSION));
            ...
            $this->session->set_flashdata('msg', '<div class="alert alert-success text-left">Front CMS Setting added successfully</div>');
