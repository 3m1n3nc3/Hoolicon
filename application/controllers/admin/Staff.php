    ...
    function create() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if (isset($_FILES["file"]) && !empty($_FILES['file']['name'])) {
                ...
                $img_name = $this->fmt_sch_name . $insert_id . '.' . $fileInfo['extension'];
            ...
            if (isset($_FILES["first_doc"]) && !empty($_FILES['first_doc']['name'])) {
                ...
                $first_title = 'resume';
                $filename = $this->fmt_sch_name . "resume" . $staff_id . '.' . $fileInfo['extension'];
            ...
            if (isset($_FILES["second_doc"]) && !empty($_FILES['second_doc']['name'])) {
                ...
                $filename = $this->fmt_sch_name . "joining_letter" . $staff_id . '.' . $fileInfo['extension'];
                $img_name = $uploaddir . $filename;
            ...
            if (isset($_FILES["third_doc"]) && !empty($_FILES['third_doc']['name'])) {
                ...
                $filename = $this->fmt_sch_name . "resignation_letter" . $staff_id . '.' . $fileInfo['extension'];
                $img_name = $uploaddir . $filename;
            ...
            if (isset($_FILES["fourth_doc"]) && !empty($_FILES['fourth_doc']['name'])) {
                ...
                $fourth_doc = $this->fmt_sch_name . "otherdocument" . $staff_id . '.' . $fileInfo['extension'];
...
$data1['date_of_leaving'] = "";
            ...
            if (isset($_FILES["file"]) && !empty($_FILES['file']['name'])) {
                $fileInfo = pathinfo($_FILES["file"]["name"]);
                $img_name = $this->fmt_sch_name . $id . '.' . $fileInfo['extension'];
                move_uploaded_file($_FILES["file"]["tmp_name"], "./uploads/staff_images/" . $img_name);
            ...
            if (isset($_FILES["first_doc"]) && !empty($_FILES['first_doc']['name'])) {
                ...
                $fileInfo = pathinfo($_FILES["first_doc"]["name"]);
                $first_title = 'resume';
                $resume_doc = $this->fmt_sch_name . "resume" . $id . '.' . $fileInfo['extension'];
            ...
            if (isset($_FILES["second_doc"]) && !empty($_FILES['second_doc']['name'])) {
                ...
                $fileInfo = pathinfo($_FILES["second_doc"]["name"]);
                $first_title = 'joining_letter';
                $joining_letter_doc = $this->fmt_sch_name . "joining_letter" . $id . '.' . $fileInfo['extension'];
            ...
            if (isset($_FILES["third_doc"]) && !empty($_FILES['third_doc']['name'])) {
                ...
                $fileInfo = pathinfo($_FILES["third_doc"]["name"]);
                $first_title = 'resignation_letter';
                $resignation_letter_doc = $this->fmt_sch_name . "resignation_letter" . $id . '.' . $fileInfo['extension'];
            ...
            if (isset($_FILES["fourth_doc"]) && !empty($_FILES['fourth_doc']['name'])) {
                ...
                $fourth_doc = $this->fmt_sch_name . "otherdocument" . $id . '.' . $fileInfo['extension'];
                $img_name = $uploaddir . $fourth_doc;
                move_uploaded_file($_FILES["fourth_doc"]["tmp_name"], $img_name);
            } else {
