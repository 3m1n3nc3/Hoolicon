            ...
            <form action="<?php echo site_url('admin/admin/updatePurchaseCode') ?>" method="POST" id="purchase_code">
                <div class="modal-body lic_modal-body">
                    ...
                    <div class="form-group">
                        <label class="ainline"><span>Purchase Code ( <a target="_blank" href="https://help.com-"> How to find it?</a> )</span></label>
                        <input type="text" class="form-control" id="input-purchase_code" name="purchase_code">
                        <div id="error" class="text text-danger"></div>
                    </div>

                    <div class="form-group">
                        <label for="exampleInputEmail1">Your Email registered or provided by Hoolicon</label>
