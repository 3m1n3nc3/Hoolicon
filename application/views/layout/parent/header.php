...
?>
                        ...
                        <li class="<?php echo set_Topmenu('Edit My Profile'); ?>"><a href="<?php echo site_url("parent/parents/edit/" . $this->children[0]['student_id']) ?>"><i class="fa fa-pencil"></i> <?php echo $this->lang->line('edit_my_profile'); ?></a></li>
                    </ul>
                </section>              
            </aside>  
