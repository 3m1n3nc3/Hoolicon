                ...
                <div class="paddtop20">
                    ...
                    <div class="col-md-6 col-md-offset-3 mt20">
                        <div class="text-center"> 
                            <img src="<?php echo base_url() ?>backend/images/paystack_secured.png" width="250">  
                        </div>
                        <br>
                        <div class="paymentbg">
                            ...
                            <!--     <form id="paymentForm" class="paddtlrb">
                                    ...
                                    <button type="submit" class="btn cfees pull-right"><i class="fa fa fa-money"></i> Pay Now </button>  
                                </form>  -->
                                <div class="paddtlrb">
                                    <span id="notification"></span>
                                    <button type="button" onclick="window.history.go(-1); return false;" name="search"  value="" class="btn btn-info"><i class="fa fa fa-chevron-left"></i> Back</button>  
                                    <button type="submit" id="paybtn" class="btn cfees pull-right"><i class="fa fa fa-money"></i> Pay Now </button> 
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        function payWithPaystack() {
            ...
            var handler = PaystackPop.setup({
                ...
                callback: function(response){
                    $.ajax({
                        url: '<?php echo base_url("students/paystack/process")?>?reference=' + response.reference,
                        method: 'post',
                        dataType: 'json',
